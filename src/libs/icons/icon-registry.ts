...
export class IconRegistry implements OnDestroy {
  ...
  /**
   * The CSS classes to apply when an `<icon>` component has no icon name, url, or font
  ...
  /**
   * Defines an alias for a CSS class name to be used for icon fonts. Creating an icon
  ...
  /**
   * Sets the CSS classes to be used for icon fonts when an `<icon>` component does not
  ...
  /**
   * Returns the CSS classes to be used for icon fonts when an `<icon>` component does not
   * have a fontSet input value, and is not loading an icon by name or URL.
   */
...
export function ICON_REGISTRY_PROVIDER_FACTORY(
  ...
  return parentRegistry || new IconRegistry(httpClient, sanitizer, document, errorHandler);
}
